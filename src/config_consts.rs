...
// Raw tare value for scale - obtained via averaging raw reading with 25g
// calibration weight, subtracting `SCALE_RAW_TARE` and dividing by 25.
pub const SCALE_RAW_1G_STEP: f32 = (43599.0 - SCALE_RAW_TARE) / 25.0;
