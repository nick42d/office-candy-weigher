...
pub const CANDY_ICON_COLOUR: Rgb565 = Rgb565::CSS_DARK_GOLDENROD;
...
pub const BATTERY_POLL_STARTUP_DELAY: Duration = Duration::from_millis(500);
pub const BATTERY_POLL_PERIOD: Duration = Duration::from_secs(60 * 10); // 10 mins
pub const BATTERY_READING_SPACING: Duration = Duration::from_secs(1);
pub const BATTERY_NUMBER_READINGS: u32 = 10;
...
pub struct OfficeCandyWeigherPeripherals {
    ...
    pub vsys_pin: Peri<'static, PIN_29>,
    pub wifi_cs_pin: Peri<'static, PIN_25>,
